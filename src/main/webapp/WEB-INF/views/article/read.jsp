			...
			<section class="content container-fluid">
				<div class="col-lg-12">
						...
						<div class="box-header with-border">
							...
							<ul class="list-inline pull-right">
								<li><a href="#" class="link-black text-lg"><i
										class="fa fa-share margin-r-5"></i>공유</a></li>
								<li><a href="#" class="link-black text-lg"><i
										class="fa fa-bookmark-o margin-r-5"></i>북마크</a></li>
								<li><a href="#" class="link-black text-lg"><i
										class="fa fa-thumbs-o-up margin-r-5"></i>추천 (0)</a></li>
								<li><a href="#" class="link-black text-lg"><i
										class="fa fa-eye margin-r-5"></i>조회수 (${boardVO.viewcnt})</a></li>
							</ul>
						</div>
						...
						<div class="box-footer">
							<div class="user-block">
								<img class="img-circle img-bordered-sm"
									src="/dist/img/default-user-image.jpg" alt="user image">
								<span class="username"> <a href="#">${boardVO.writer}</a>
					...
					<div>
						...
						<button type="submit" class="btn btn-primary listBtn pull-right">
